...
class SkillCrystallizer:
    ...
    def __init__(
        self,
        propose_fn: Callable[[list[Any]], list[dict[str, Any]]],
    ) -> None:
    ...
    def run(
        ...
        *,
        ...
        Analysed patterns that exceed the threshold are converted to
        ...
        try:
            ...
            # Fall back: persist raw proposals so they are not lost
            for p in raw_proposals:
                try:
                    self.propose([p])  # type: ignore[arg-type]
                except Exception:
                    pass
