...
Select the minimum useful expert set and invoke only those specialists.

- Triggers: expert pool, specialist, choose experts
- Stack: generic
- Owner: system
- Weight: 4

## Use it for
- Mixed-domain tasks where only a few experts are needed.
- Preventing context bloat from unnecessary agents.
