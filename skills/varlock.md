...
Keep environment variables and secrets out of logs, shells, and commits.

- Triggers: varlock, env vars, secrets, leak
- Stack: security, devops
- Owner: security
- Weight: 5

## Use it for
- Securely loading secret-bearing environment data.
- Preventing accidental exposure in traces or command history.
- Enforcing consistent secret-handling discipline.
